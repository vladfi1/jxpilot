...
public class CannonRightBlock extends CannonHolder implements AbstractBlock {
	public static final Color CANNON_RIGHT_COLOR = Color.WHITE;
	
	private static final Polygon2D CANNON_RIGHT_POLYGON2D;
	public static final Polygon2DAdaptor getCannonRightPolygon2D() {return CANNON_RIGHT_POLYGON2D;}
	
	private static final BufferedImage CANNON_RIGHT_IMAGE;
	
	static {
		CANNON_RIGHT_POLYGON2D = new Polygon2D(new Vector2D[]{
				new Vector2D(0,0),
		...
		CANNON_RIGHT_POLYGON2D.draw(g2d);
		g2d.dispose();
	}
